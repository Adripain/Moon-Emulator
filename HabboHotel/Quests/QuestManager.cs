...
namespace Moon.HabboHotel.Quests
{
    public class QuestManager
    {
        private static readonly ILog log = LogManager.GetLogger("Moon.HabboHotel.Quests.QuestManager");
