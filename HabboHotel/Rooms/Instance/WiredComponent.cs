...
using Moon.HabboHotel.Items.Wired.Boxes.Triggers;

using Moon.HabboHotel.Items.Wired.Boxes.Effects;
using Moon.HabboHotel.Items.Wired.Boxes.Conditions;
using Moon.HabboHotel.Items.Wired.Boxes.Add_ons;

using Moon.Database.Interfaces;
using System.Drawing;

namespace Moon.HabboHotel.Rooms.Instance
{
