    ...
    public class RoomUser
    {
        ...
        public string GetUsername()
        {
            ...
            if (GetClient() != null)
            {
                if (GetClient().GetHabbo() != null)
                {
                    ...
                    return MoonEnvironment.GetUsernameById(HabboId);
        ...
        public bool IncrementAndCheckFlood(out int MuteTime)
        {
            ...
            else if (ChatSpamCount >= 6)
            {
                ...
                GetClient().GetHabbo().FloodTime = MoonEnvironment.GetUnixTimestamp() + MuteTime;
        ...
        public void OnChat(int Colour, string Message, bool Shout)
        {
            ...
            if (Shout)
                Packet = new ShoutComposer(VirtualId, ColouredMessage, MoonEnvironment.GetGame().GetChatManager().GetEmotions().GetEmotionsForText(Message), Colour);
            else
                Packet = new ChatComposer(VirtualId, ColouredMessage, MoonEnvironment.GetGame().GetChatManager().GetEmotions().GetEmotionsForText(Message), Colour);
        ...
        public void SendNameColourPacket()
        {
            ...
            if (GetClient().GetHabbo()._tag == "off" || GetClient().GetHabbo()._tag == "")
            {
                ...
                if (GetClient().GetHabbo()._nameColor == "azulyazul")
                    Username = "<font size='" + GetClient().GetHabbo().chatHTMLSize + "'>" + PurchaseFromCatalogEvent.GeneratecolorforbiText(GetUsername()) + "</font>";
            ...
            else
            {
                if (GetClient().GetHabbo()._tagcolor == "rainbow")
                    Username = "<font color='" + MoonEnvironment.RainbowT() + "'>" + GetClient().GetHabbo()._tag + "</font> <font size='" + GetClient().GetHabbo().chatHTMLSize + "' color=\"#" + GetClient().GetHabbo()._nameColor + "\">" + GetUsername() + "</font>";
                else
                ...
                if (GetClient().GetHabbo()._nameColor == "azulyazul")
                    Username = "<font size='" + GetClient().GetHabbo().chatHTMLSize + "'><font color='#" + GetClient().GetHabbo()._tagcolor + "'>" + GetClient().GetHabbo()._tag + "</font> " + PurchaseFromCatalogEvent.GeneratecolorforbiText(GetUsername()) + "</font>";
        ...
        public GameClient GetClient()
        {
            ...
            if (mClient == null)
                mClient = MoonEnvironment.GetGame().GetClientManager().GetClientByUserID(HabboId);
            return mClient;
        }
        ...
        {
            if (mRoom == null)
                if (MoonEnvironment.GetGame().GetRoomManager().TryGetRoom(RoomId, out mRoom))
                    return mRoom;
