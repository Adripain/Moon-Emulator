...
//            StartedPlayTimestamp = (int)MoonEnvironment.GetUnixTimestamp();
...
//            get
//            {
//                return (int)MoonEnvironment.GetUnixTimestamp() - StartedPlayTimestamp;
//            }
//        }
...
//                if (item.GetBaseItem().InteractionType == InteractionType.JUKEBOX || item.GetBaseItem().InteractionType == InteractionType.TRAX)
//                {
