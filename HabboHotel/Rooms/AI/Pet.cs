...
namespace Moon.HabboHotel.Rooms.AI
{
    public class Pet
    {
        public int PetId;
        ...
        public void Addexperience(int Amount)
        {
            ...
            if (Room != null)
            {
                ...
                {
                    if (MoonEnvironment.GetGame().GetClientManager().GetClientByUserID(OwnerId) != null)
                    {
                        MoonEnvironment.GetGame().GetAchievementManager().ProgressAchievement(MoonEnvironment.GetGame().GetClientManager().GetClientByUserID(OwnerId), "ACH_PetLevelUp", 1);
                    }
        ...
        public void PetEnergy(bool Add)
        {
            ...
            int r = MoonEnvironment.GetRandomNumber(4, MaxE);
        ...
        public Room Room
        {
            get
            {
                ...
                if (MoonEnvironment.GetGame().GetRoomManager().TryGetRoom(RoomId, out _room))
                    return _room;
                else
                    return null;
        ...
        public int Age
        {
            get { return Convert.ToInt32(Math.Floor((MoonEnvironment.GetUnixTimestamp() - CreationStamp) / 86400)); }
        }
        ...
        {
            get { return MoonEnvironment.GetGame().GetClientManager().GetNameById(OwnerId); }
        }
    }
