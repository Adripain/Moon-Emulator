...
namespace Moon.HabboHotel.Permissions
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Moon.HabboHotel.Permissions.PermissionManager");
        ...
        public void Init()
        {
            ...
            log.Info(">> Permissions Manager -> Pronto!");
        }
        ...
        {
            return this._commands.Where(x => id == x.Value.GroupId).Select(x => x.Key).ToList();
        }
    }
}