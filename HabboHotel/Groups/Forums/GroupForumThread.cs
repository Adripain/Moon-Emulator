...
namespace Moon.HabboHotel.Groups.Forums
{
    public class GroupForumThread
    {
        ...
        public GroupForumThread(GroupForum parent, int id, int userid, int timestamp, string caption, bool pinned, bool locked, int deletedlevel, int deleterid)
        {
            ...
            DeletedTimestamp = (int)MoonEnvironment.GetUnixTimestamp();
        ...
        {
            return MoonEnvironment.GetHabboById(UserId);
        }

        public Habbo GetDeleter()
        {
            return MoonEnvironment.GetHabboById(DeleterUserId);
        }

        public GroupForumThreadPost CreatePost(int userid, string message)
        {
            var now = (int)MoonEnvironment.GetUnixTimestamp();
        ...
        public void SerializeData(GameClient Session, ServerPacket Packet)
        {
            ...
            Packet.WriteInteger((int)(MoonEnvironment.GetUnixTimestamp() - Timestamp)); //Created Secs Ago
            ...
            Packet.WriteInteger(!isn ? (int)(MoonEnvironment.GetUnixTimestamp() - lastpost.Timestamp) : 0); //Last message timestamp
            ...
            if (deleter != null)
            {
                ...
                Packet.WriteInteger((int)(MoonEnvironment.GetUnixTimestamp() - DeletedTimestamp));//deleted secs ago
            }
            else
            {
