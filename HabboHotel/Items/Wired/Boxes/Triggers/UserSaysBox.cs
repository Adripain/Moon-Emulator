...
namespace Moon.HabboHotel.Items.Wired.Boxes.Triggers
{
    class UserSaysBox : IWiredItem
    {
        ...
        public void HandleSave(ClientPacket Packet)
        {
            ...
            this.StringData = Message.ToLower();
        ...
        public bool Execute(params object[] Params)
        {
            ...
            if (Message.ToLower().Equals(" " + this.StringData.ToLower()) || Message.ToLower().Equals(" " + this.StringData.ToLower() + " ") || Message.ToLower().Equals(this.StringData.ToLower() + " ") || Message.ToLower().Equals(this.StringData.ToLower()))
            {
