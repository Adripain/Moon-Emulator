...
{
    class AddScoreBox2 : IWiredItem, IWiredCycle
    {
        ...
        public AddScoreBox2(Room Instance, Item Item)
        {
        ...
        private void TeleportUser(Habbo Player)
        {
            ...
            if ((Instance == null || User == null ? false : !User.IsBot))
            {
                ...
                {
                    dbClient.RunQuery("UPDATE users SET puntos_eventos = puntos_eventos + '" + mScore + "' WHERE id = '" + User.UserId + "'");
                    dbClient.RunQuery("UPDATE users SET premio = premio + '1' WHERE id = '" + User.UserId + "'");
                }
                ...
                if (Player.Effects() != null)
                    Player.Effects().ApplyEffect(165);
            }
        }
    }
}