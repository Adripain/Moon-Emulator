...
{
    class ActorHasNotCreditsBox : IWiredItem
    {
        public Room Instance { get; set; }
        public Item Item { get; set; }
        public WiredBoxType Type { get { return WiredBoxType.ConditionActorHasNotCredits; } }
        ...
        public bool Execute(params object[] Params)
        {
            ...
            if (User.GetClient().GetHabbo().Credits > int.Parse(this.StringData))
                return false;
