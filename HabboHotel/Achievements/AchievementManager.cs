...
namespace Moon.HabboHotel.Achievements
{
    public class AchievementManager
    {
        private static readonly ILog log = LogManager.GetLogger("Moon.HabboHotel.Achievements.AchievementManager");
        ...
        public AchievementManager()
        {
            ...
            log.Info(">> Achievement Manager -> Pronto!");
        }
        ...
        public void TryProgressLoginAchievements(GameClient Session)
        {
            ...
            Double daysBtwLastLogin = MoonEnvironment.GetUnixTimestamp() - Session.GetHabbo().LastOnline;
        ...
        public void TryProgressRegistrationAchievements(GameClient Session)
        {
            ...
            double sinceMember = MoonEnvironment.GetUnixTimestamp() - (int)Session.GetHabbo().AccountCreated;
        ...
        public void TryProgressHabboClubAchievements(GameClient Session)
        {
            ...
            Double SinceActivation = MoonEnvironment.GetUnixTimestamp() - Subscription.ExpireTime;
        ...
        public bool ProgressAchievement(GameClient Session, string AchievementGroup, int ProgressAmount, bool FromZero = false)
        {
            ...
            if (NewProgress >= TargetLevelData.Requirement)
            {
                ...
                // Set Talent
                Talent talent = null;
                if (MoonEnvironment.GetGame().GetTalentManager().TryGetTalent(AchievementGroup, out talent))
                    MoonEnvironment.GetGame().GetTalentManager().CompleteUserTalent(Session, talent);
                return true;
            }
            else
            {
