...
using Moon.HabboHotel.Users.Inventory.Pets;
...
namespace Moon.HabboHotel.Users.Inventory
{
    public class InventoryComponent
    {
        ...
        {
            return MoonEnvironment.GetGame().GetClientManager().GetClientByUserID(_userId);
        }
