...
namespace Moon.Communication.Packets.Incoming
{
    public class ClientPacket
    {
        ...
        {
            return "[" + Header + "] BODY: " + (MoonEnvironment.GetDefaultEncoding().GetString(Body).Replace(Convert.ToChar(0).ToString(), "[0]"));
        }
        ...
        {
            return MoonEnvironment.GetDefaultEncoding().GetString(ReadFixedValue());
        }
