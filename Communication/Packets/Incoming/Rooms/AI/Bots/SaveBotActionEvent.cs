                ...
                case 2:
                    {
                        ...
                        using (IQueryAdapter dbClient = MoonEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
                            ...
                            for (int i = 0; i <= SpeechData.Length - 1; i++)
                            {
                                ...
                                dbClient.AddParameter("MixChat", MoonEnvironment.BoolToEnum(Convert.ToBoolean(MixChat)));
                                dbClient.RunQuery();
                            }
                            #endregion
                ...
                case 5:
                    {
                        ...
                        {
                            Session.SendWhisper("El nombre del bot no puede superar los 16 caracteres.");
                            return;
                        }
                        ...
                        {
                            Session.SendWhisper("¿Qué intentas, crack?");
                            return;
                        }
